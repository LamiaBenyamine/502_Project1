...
## Summary Table
Combining the results from the properties of all the above methods into a table.
...
This is a Comparison of Coverage Probabilities for the alpha 95% Wald, Adjusted Wald, Clopper-Pearson, Score, and Bootstrap Intervals for each sample size.
...
This is a Comparison of interval lengths for the alpha 95% Wald, Adjusted Wald, Clopper-Pearson, Score, and Bootstrap Intervals for each sample size.
...
The observed coverage began to get closer to the expected 0.95 level as the sample size grew. We do see an improvement between the Wald and the Adjusted Wald intervals